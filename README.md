...
## 🔥 News
-2026.03 🌸🌸 We have successfully adapted MIND to **Qwen2.5-VL**, **Qwen3-VL**, and **Qwen3.5**. Preliminary experimental results show a significant improvement in performance. the code will be open-sourced shortly.  
